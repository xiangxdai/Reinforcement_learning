...
#self.num_env_steps修改为10000，原本10e6
def _t2n(x):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                #环境下一次输出的obs还是(5action_dim, 2agent_num, 14obs_dim )的形式，
                # 之后调insert方法将数据添加到buffer里面，
                # 在insert方法里面会将局部观测构造一个全局观测share_obs其shape=(5, 2, 28)出来：
                self.insert(data)
